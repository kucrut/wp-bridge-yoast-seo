...
define( 'BRIDGE_TESTS_BRIDGE_DIR', BRIDGE_TESTS_PLUGINS_DIR . '/bridge-yoast-seo' );
...
function _manually_load_plugin() {
	...
	// WP SEO.
	require_once BRIDGE_TESTS_PLUGINS_DIR . '/wordpress-seo/wp-seo.php';

	// Bridge.
	require_once BRIDGE_TESTS_BRIDGE_DIR . '/plugin.php';
}
